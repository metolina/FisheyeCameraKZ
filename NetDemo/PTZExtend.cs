...
namespace NetDemo
{
    public partial class PTZExtend : Form
    {
        ...
        List<GeneralDef.DeviceInfo> m_deviceInfoList = null;
        ...
        private void PresetPatrolsIDCobBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            GeneralDef.DeviceInfo deviceInfo = m_deviceInfoList[m_curSelectedTreeDeviceIndex];
            ...
            //peki bir şey soracağım normalde bu kamera şöyle
            GeneralDef.ChannelInfo channelInfo = deviceInfo.m_channelInfoList[m_curSelectedTreeChannelIndex];
